...
betacustomer_api_recoverable = Blueprint('betacustomer_api_recoverable', __name__, url_prefix='/api/v1/betacustomer')
...
@betacustomer_api_recoverable.route("/statistics", methods=["GET"])
def get_statistics():
    """
