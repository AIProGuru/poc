    ...
    <div className="mb-6 w-full" ref={wrapperRef}>
      ...
      <div className="relative">
        ...
        >
          ...
          <input
            type="text"
            className={`flex-1 outline-none min-w-[60px] text-sm ${theme === 'dark'
        ...
        {isOpen && (
          <div className={`absolute z-50 w-full mt-1 rounded-lg shadow-lg border ${theme === 'dark'
              ? 'bg-[#27282D] border-gray-600'
