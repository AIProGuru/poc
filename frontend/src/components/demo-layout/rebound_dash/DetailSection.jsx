      ...
      <div className={`flex justify-between items-center select-none py-[8px] pl-[12px] ${isDark ? 'bg-[#27282D] text-gray-200' : 'bg-white text-[#072F40]'}`}>
        ...
        {showArrow && (
          <div className='pr-[36px] cursor-pointer' onClick={() => setCollapse(value => !value)}>
            ...
            >
              <path fillRule={"evenodd"} clipRule={"evenodd"} d="M0.40814 0.910826C0.733577 0.585389 1.26121 0.585389 1.58665 0.910826L5.9974 5.32157L10.4081 0.910826C10.7336 0.585389 11.2612 0.585389 11.5867 0.910826C11.9121 1.23626 11.9121 1.7639 11.5867 2.08934L6.58665 7.08934C6.26121 7.41477 5.73358 7.41477 5.40814 7.08934L0.40814 2.08934C0.0827033 1.7639 0.0827033 1.23626 0.40814 0.910826Z" fill={isDark ? '#CBD5E1' : '#3a3f46'} />
            </svg>
          </div>
        )}
      </div>
