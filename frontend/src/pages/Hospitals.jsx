  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto flex flex-col md:gap-[200px] gap-[120px] overflow-visable">
        <div className="flex gap-4 justify-center items-center lg:gap-32 md:flex-row flex-col">
          <div className="flex flex-col md:max-w-[380px] gap-8 md:order-1 order-2 mt-4 w-full">
            ...
            <p className="text-[20px] text-[#475569] leading-[28px]">
              Bring the power of AI to your existing tech stack without any
              disruptions. From large multi-site hospital networks to regional
              healthcare systems, our AI agents have been developed to integrate
        ...
        <div className="flex justify-center items-center relative md:flex-row flex-col overflow-visable">
          {/* <img
            src="/Group.png"
            alt=""
            className="max-w-[833px] md:absolute -left-20 w-[160%]"
          /> */}
          <div className="flex flex-col gap-8 md:py-[75px] relative w-full">
            ...
            <p className="text-[20px] leading-[24px] text-[#475569]">
              ...
              Unlock hidden revenue from denied claims.
            </p>
            <p className="text-[20px] leading-[24px] text-[#475569]">
              <strong className="text-[#0F172A] font-bold">
                Liberate Cash Flow:
            ...
            <p className="text-[20px] leading-[24px] text-[#475569]">
              ...
              Cut manual processes and administrative costs
            </p>
          </div>
        </div>
        {/* <div className="flex">
      ...
      <div className="mx-[1rem] sm:mx-[2rem] lg:mx-[4rem] xl:mx-[5rem] 2xl:mx-[6rem] flex justify-center mt-20 mb-10 sm:mb-32">
        <Discover_all
          title="Elevate Your Service Offerings"
          desc="Expand your solutions with AI-powered denial recovery that drives measurable results."
          link="/#aidenial"
          button="Explore More"
        />
      </div>
