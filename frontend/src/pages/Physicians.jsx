...
const Physicians = () => {
  ...
  return (
    ...
    >
      ...
      <div className="hero mt-32 relative w-full h-full md:mb-20 mb-1">
        ...
        <div className="container mx-auto flex overflow-hidden">
          <div className="xl:w-1/2 lg:w-[60%] gap-8 flex flex-col text-center sm:text-left sm:w-[80%] w-full overflow-visible">
            ...
            >
              Administrative Overload Taking Revenue Hostage?
            </h1>
            <p className="text-[20px] text-[#475569] leading-[28px] md:w-[72%] w-full z-20">
              Our solution tackles the one problem that prevents physician
              practices & providers like you from properly contesting denied
      ...
      <div className="container mx-auto flex flex-col md:gap-[200px] gap-[120px] md:mt-0 mt-8">
        <div className="flex gap-4 justify-center items-center lg:gap-32 md:flex-row flex-col">
          <div className="flex flex-col md:max-w-[380px] w-full gap-8 md:order-1 order-2 mt-4 md:mt-0">
            <h1
            ...
            <p className="text-[20px] text-[#475569] leading-[28px]">
              Our AI agents utilize intelligent data analysis to find missed
              revenue, use real-time insights to prevent denials, and speed up
              revenue cash cycles to ensure optimal recoveries.
            </p>
          </div>
        ...
        <div className="flex justify-center items-center relative md:flex-row flex-col w-full">
          
          <div className="w-1/2"></div>
          <div className="flex flex-col gap-8 py-[75px] relative max-w-[420px]">
            ...
            <p className="text-[20px] leading-[24px] text-[#475569]">
              Our fully autonomous AI agents evolve and grow their understanding
              of your processes over time, becoming exponentially better at
              preventing denied claims amid changing payer policies and denial
              trends.
            </p>
          </div>
        </div>
        ...
        <div className="flex justify-center items-center relative md:flex-row flex-col overflow-x-visible">
          <div className="flex flex-col md:max-w-[380px] w-full gap-8 md:order-1 order-2">
            <h1
            ...
            <p className="text-[20px] leading-[24px] text-[#475569]">
              <strong className="text-[#0F172A] font-bold">
                Effortless Denial Recovery:
              </strong>{" "}
              Fully autonomous resubmissions and appeals.
            </p>
            <p className="text-[20px] leading-[24px] text-[#475569]">
              <strong className="text-[#0F172A] font-bold">
                Reduced Manual Load:
              </strong>{" "}
              Free your team from manual claim processes.
            </p>
            <p className="text-[20px] leading-[24px] text-[#475569]">
              <strong className="text-[#0F172A] font-bold">
                Improve Patient Care:
              </strong>{" "}
              Cut delays and enhance service delivery.
            </p>
          </div>
